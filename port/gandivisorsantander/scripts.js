...
async function carregarArquivoAtual() {
    ...
    document.getElementById('detectedCNJ').innerHTML = numeroCNJ 
        ? `<span style="color: #2e7d32;">${numeroCNJ} ✓</span>`
        : `<span style="color: #c62828;">❌ Não detectado no nome do arquivo</span>`;
...
function atualizarPreview() {
    ...
    document.getElementById('previewInicial').innerHTML = `
        ...
        <small style="color: #666;">Inicial${sufixoCNJ}.pdf</small>
    `;
    ...
    if (paginasDocs > 0) {
        document.getElementById('previewDocs').innerHTML = `
            ...
            <small style="color: #666;">Docs Inicial${sufixoCNJ}.pdf</small>
        `;
    } else {
        document.getElementById('previewDocs').innerHTML = `
            <strong>Nenhuma página</strong><br>
            <small style="color: #666;">(Todas as páginas estão na "Inicial")</small>
        `;
    }
...
function finalizarProcessamento() {
    ...
    document.getElementById('resultMessage').innerHTML = `
        <h3 style="color: #2e7d32;">🎉 Processamento Concluído!</h3><br>
...
function aplicarCNJManual() {
    ...
    document.getElementById('detectedCNJ').innerHTML = `<span style="color: #2e7d32;">${numeroCNJ} ✓ (Manual)</span>`;
    document.getElementById('cnjWarning').style.display = 'none';
